...
- **Main Features (Phase1 Mock)**:
  ...
  - HPエディタ（自動保存デバウンス、保存状態表示、セクションON/OFF・並び替え、OFFセクションの編集項目自動非表示、改行入力対応、コントラスト警告、各セクション本文編集、料金編集、画像アップロード[5MB以内]）
...
6. `/editor/site-001` 下部の「トッピング（このHP）」でHP単位トッピングON/OFF確認
